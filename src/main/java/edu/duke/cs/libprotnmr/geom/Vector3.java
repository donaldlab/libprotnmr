...
public class Vector3 implements Serializable, Comparable<Vector3>, Fuzzy<Vector3>
{
	/**************************
	 *   Definitions
	 **************************/
	...
	public static List<Vector3> asList( List<Vector2> twod )
	{
		return asList( twod, 0.0 );
	}
	
	public static List<Vector3> asList( List<Vector2> twod, double z )
	{
		List<Vector3> threed = new ArrayList<Vector3>( twod.size() );
		for( Vector2 p : twod )
		{
			threed.add( new Vector3( p.x, p.y, z ) );
		}
		return threed;
	}
